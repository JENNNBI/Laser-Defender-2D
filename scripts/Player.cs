...
public class Player : MonoBehaviour {
    ...
    [SerializeField] AudioClip PlayerDestroySFX;
    ...
    {
        AudioSource.PlayClipAtPoint(PlayerDestroySFX, Camera.main.transform.position, PlayerDestroySoundVolume);
    }
    ...
    private void Fire()
    {
        ...
        {
            AudioSource.PlayClipAtPoint(PlayerProjectileSFX, Camera.main.transform.position);
